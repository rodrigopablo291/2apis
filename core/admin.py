...
class Usuarioadmin(admin.ModelAdmin):
    list_display = ('id','username','idtipousuario','password')
...
class EmpresaTitularBeneficioadmin(admin.ModelAdmin):
    list_display = ('id','idempresatitular','idproductoempresatitular','idcategoriabeneficio','idempresabeneficio','nombrebeneficio','fechainicio','fechatermino','checklu','checkma','checkmi','checkju','checkvi','checksa','checkdo')
