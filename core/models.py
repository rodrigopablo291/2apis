...
class IndustriaEmpresaTitular(models.Model):
    id = models.IntegerField(unique=True)
    nombreindustria = models.CharField(max_length=30,primary_key=True)
...
class EmpresaTitular(models.Model):
    id = models.IntegerField(unique=True)
    idindustriaempresatitular = models.ForeignKey(IndustriaEmpresaTitular,to_field='nombreindustria',on_delete=models.CASCADE)
    nombreempresatitular = models.CharField(max_length=30,primary_key=True)
...
class ProductoEmpresaTitular(models.Model):
    id = models.IntegerField(unique=True)
    idempresatitular = models.ForeignKey(EmpresaTitular,to_field='nombreempresatitular',on_delete=models.CASCADE)
    nombreproducto = models.CharField(max_length=30,primary_key=True)
    descripcion = models.CharField(max_length=100)
    def __str__(self):
            return '{} - {} '.format(self.idempresatitular,self.nombreproducto)
...
class CategoriaBeneficio(models.Model):
    id = models.IntegerField(unique=True)
    nombrecategoriabeneficio = models.CharField(max_length=30,primary_key=True)
    descripcion = models.CharField(max_length=100)
    def __str__(self):
...
class EmpresaBeneficio(models.Model):
    id = models.IntegerField(unique=True)
    nombreempresabeneficio = models.CharField(max_length=30,primary_key=True)
    descripcion = models.CharField(max_length=100)
    def __str__(self):
...
class EmpresaTitularBeneficio(models.Model):
    id = models.IntegerField(unique=True)
    idempresatitular = models.ForeignKey(EmpresaTitular,to_field='nombreempresatitular',on_delete=models.CASCADE)
    idproductoempresatitular = models.ForeignKey(ProductoEmpresaTitular,to_field='nombreproducto',on_delete=models.CASCADE)
    idcategoriabeneficio = models.ForeignKey(CategoriaBeneficio,to_field='nombrecategoriabeneficio',on_delete=models.CASCADE)
    idempresabeneficio = models.ForeignKey(EmpresaBeneficio,to_field='nombreempresabeneficio',on_delete=models.CASCADE)
    nombrebeneficio = models.CharField(max_length=30,primary_key=True)
...
class CategoriaPreferenciaPersonal(models.Model):
    id = models.IntegerField(unique=True)
    nombrecategoriapreferencia = models.CharField(max_length=50,primary_key=True)
    descripcion = models.CharField(max_length=100)
    def __str__(self):
...
class PreferenciaPersonal(models.Model):
    ...
    idcategoriapreferenciapersonal = models.ForeignKey(CategoriaPreferenciaPersonal,to_field='nombrecategoriapreferencia',on_delete=models.CASCADE)
    descripcion = models.CharField(max_length=100)
    def __str__(self):
